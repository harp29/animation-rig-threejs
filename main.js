function init() {
	...
	var gui = new dat.GUI();
	//will be using to determine time passed
	...
	//name object so can use later in update()
...
function update(renderer, scene, camera, controls, clock) {
    ...
    //get object name 'boxGrid' to animate - connected to the scene object
	var boxGrid = scene.getObjectByName('boxGrid');
	//loop through each child and animate
